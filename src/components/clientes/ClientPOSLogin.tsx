...
import { Monitor, LogIn, Download, HeadphonesIcon, Eye, EyeOff, ShieldCheck, Mail, Lock, KeyRound } from "lucide-react";
              ...
              <CardContent className="space-y-4">
                {supportView === "options" && (
                  <>
                    <p className="text-sm text-muted-foreground">
                      Accede a soporte técnico, entrenamientos y descargas.
                    </p>
                    <Button
                ...
                {supportView === "login" && (
                  <form onSubmit={handleSupportLogin} className="space-y-4">
                    ...
                    <Button type="submit" className="w-full" size="lg" disabled={supportLoading}>
                      {supportLoading ? "Ingresando..." : "Ingresar al Soporte"}
                    </Button>
                    <button
                      type="button"
                ...
                {supportView === "forgot" && (
                  <div className="space-y-4">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">Te enviaremos un enlace a tu correo para crear tu contraseña.</p>
                    </div>
                    <div className="space-y-1.5">
                    ...
                    >
                      {supportLoading ? "Enviando..." : "Enviar Enlace de Contraseña"}
                    </Button>
                    <button
                      type="button"
                      className="w-full text-sm text-muted-foreground hover:text-primary transition-colors"
