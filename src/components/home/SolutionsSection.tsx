...
const solutions = [
  {
    ...
    description: "Comandas, mesas, división de cuentas y cocina conectada.",
  ...
  },
  {
    ...
    description: "Inventario, códigos de barras y control de precios.",
  ...
  },
  {
    ...
    description: "Tallas, colores, temporadas y control de stock.",
    href: "/pos-para-retail",
  ...
  },
  {
    ...
    description: "Miles de referencias, unidades de medida y cotizaciones.",
    href: "/pos-para-retail",
  ...
  },
  {
    ...
    description: "Seriales, garantías y control de equipos.",
    href: "/pos-para-retail",
  ...
  },
  {
    ...
    description: "Servicios, citas, productos y comisiones.",
    href: "/pos-para-retail",
