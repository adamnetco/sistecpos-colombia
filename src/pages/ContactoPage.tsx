...
const socialLinks = [
  { name: "WhatsApp", icon: MessageCircle, href: "https://wa.me/573176268307", color: "bg-[#25D366] hover:bg-[#128C7E]" },
  { name: "Instagram", icon: Instagram, href: "https://www.instagram.com/sistecpos", color: "bg-gradient-to-r from-[#833AB4] via-[#FD1D1D] to-[#F77737] hover:opacity-90" },
  { name: "Facebook", icon: Facebook, href: "https://www.facebook.com/sistecpos", color: "bg-[#1877F2] hover:bg-[#0C63D4]" },
  { name: "YouTube", icon: Youtube, href: "https://www.youtube.com/user/sistecpos", color: "bg-[#FF0000] hover:bg-[#CC0000]" },
  { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/company/sistecpos", color: "bg-[#0A66C2] hover:bg-[#004182]" },
